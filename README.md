...
- <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Web_API_Logo.svg/512px-Web_API_Logo.svg.png" alt="API" width="22"/> **Nager.Date (API):** API utilizada para obtener información de feriados, mejorando la funcionalidad del sistema.
