...
- <img src="http://www.w3.org/2000/svg" alt="API" width="22"/> **Nager.Date (API):** API utilizada para obtener información de feriados, mejorando la funcionalidad del sistema.
