...
- <img src="https://upload.wikimedia.org/wikipedia/commons/6/6a/API_icon.svg" alt="API" width="22"/> **Nager.Date (API):** API utilizada para obtener información de feriados, mejorando la funcionalidad del sistema.
