...
- <img src="https://upload.wikimedia.org/wikipedia/commons/8/84/Api-gateway.svg" alt="API" width="22"/> **Nager.Date (API):** API utilizada para obtener información de feriados, mejorando la funcionalidad del sistema.
