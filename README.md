...
- <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/apachenetbeans.svg" alt="API" width="22"/> **Nager.Date (API):** API utilizada para obtener información de feriados, mejorando la funcionalidad del sistema.
